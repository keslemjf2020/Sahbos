...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'IA para Startups: Do MVP ao Lancamento em Tempo Recorde', images: [{ url: 'https://images.unsplash.com/photo-1677442136019-21765a90f986?w=1200&h=630&fit=crop', width: 1200, height: 630 }] }
};
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      <div className="relative w-full h-48 md:h-80 overflow-hidden">
        <img src="https://images.unsplash.com/photo-1677442136019-21765a90f986?w=1200&h=400&fit=crop" alt="IA para Startups: Do MVP ao Lancamento em Tempo Recorde" className="w-full h-full object-cover opacity-50" />
