...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Guia de Monetizacao: AdSense e Afiliados para Blogs', images: [{ url: 'https://images.unsplash.com/photo-1531747118028-2f5e5e5e5e5e?w=1200&h=630&fit=crop', width: 1200, height: 630 }] }
};
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      <div className="relative w-full h-48 md:h-80 overflow-hidden">
        <img src="https://images.unsplash.com/photo-1531747118028-2f5e5e5e5e5e?w=1200&h=400&fit=crop" alt="Guia de Monetizacao: AdSense e Afiliados para Blogs" className="w-full h-full object-cover opacity-50" />
