...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'No-Code vs Low-Code: Melhores Ferramentas Gratis', images: [{ url: 'https://placehold.co/1200x630/0a0a0f/8b5cf6?text=No-Code%20vs%20Low-Code%3A%20Melhores%20Ferramentas%20Gratis', width: 1200, height: 630 }] }
};
