...
export const metadata: Metadata = {
  title: 'ChatGPT vs DeepSeek vs Claude: Qual a Melhor IA em 2026 - Automacao IA',
  openGraph: { title: 'ChatGPT vs DeepSeek vs Claude: Qual a Melhor IA em 2026', images: [{ url: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=630&fit=crop', width: 1200, height: 630 }] }
};
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      <div className="relative w-full h-48 md:h-80 overflow-hidden">
        <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=400&fit=crop" alt="ChatGPT vs DeepSeek vs Claude: Qual a Melhor IA em 2026" className="w-full h-full object-cover opacity-50" />
