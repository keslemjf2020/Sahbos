...
export const metadata: Metadata = {
  title: 'IA para Professores: Ferramentas que Transformam o Ensino - Automacao IA',
  openGraph: { title: 'IA para Professores: Ferramentas que Transformam o Ensino', images: [{ url: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&h=630&fit=crop', width: 1200, height: 630 }] }
};
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      <div className="relative w-full h-48 md:h-80 overflow-hidden">
        <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&h=400&fit=crop" alt="IA para Professores: Ferramentas que Transformam o Ensino" className="w-full h-full object-cover opacity-50" />
